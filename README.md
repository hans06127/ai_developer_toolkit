...
The v0.2.0 release runs entirely in the browser. It has no backend, authentication, analytics, AI API calls, parsers, OCR, or cloud sync.

## Features

- Collect the current page title, URL, selected text, source type, tags, notes, and timestamp.
...
- v0.3: Search, import, and export workflows for portable context bundles.
